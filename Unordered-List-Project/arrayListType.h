...
public:
    ...
    int retrieveAt(int location) const;
      ...
      //Postcondition: returns the element of the index.
    ...
    virtual void removeAll(int removeItem) = 0;
      //Function to remove ALL removeItems from the list
      //This is pure virtual fuction.
      //Postcondition: if removeItem is found in the list,
      //               1. it is removed from the list,
      //               2.length is decremented by one and
      //               3.keep finding if there is the same value of
      //               removeItem in the list. If found, iterate the //               steps above/
